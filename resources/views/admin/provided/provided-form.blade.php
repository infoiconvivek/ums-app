...
@section('content')
@section('title', 'Add User Provided')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">@if(isset($category)) Edit @else Add @endif User Provided</h4>
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                ...
                                <form method="post" action="{{url('admin/provided/save')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row gy-4">
