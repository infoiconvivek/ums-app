                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">User Provided List</h4>
                            <div class="flex-shrink-0">
                                <a href="{{url('admin/provided/create')}}" class="btn btn-info">Add Provided</a>
                            </div>
                        </div><!-- end card header -->
                                    ...
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr row_id="{{$row->id}}" class="get_row_{{$row->id}}">
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm waves-effect waves-light" href="{{url('admin/provided/edit/'.$row->id)}}">
